...
public sealed class OpcoesDeTokenJwt
{
...
public sealed class ServicoDeTokenJwt : IServicoDeToken
{
    private readonly OpcoesDeTokenJwt _opcoes;

    public ServicoDeTokenJwt(IOptions<OpcoesDeTokenJwt> opcoes)
    {
