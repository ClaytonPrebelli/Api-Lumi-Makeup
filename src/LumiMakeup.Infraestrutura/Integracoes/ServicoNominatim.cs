...
public sealed class ServicoNominatim : IServicoNominatim
{
    private readonly HttpClient _httpClient;
    private readonly ILogger<ServicoNominatim> _logger;

    public ServicoNominatim(HttpClient httpClient, ILogger<ServicoNominatim> logger)
    {
